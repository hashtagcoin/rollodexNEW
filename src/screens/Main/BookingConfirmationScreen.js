...
const BookingConfirmationScreen = ({ route }) => {
  ...
  const calculatePaymentDetails = () => {
    ...
    // Assume 85% NDIS coverage for demonstration
    const ndisCoverage = totalCost * 0.85;
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      const booking = await createBooking(serviceData.id, selectedTimeSlot, selectedDate, paymentData);
