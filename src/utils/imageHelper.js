...
// Using picsum.photos as a more reliable alternative to via.placeholder.com
const DEFAULT_IMAGES = {
  service: 'https://picsum.photos/400/300?text=Service',
  housing: 'https://picsum.photos/400/300?text=Housing',
  user: 'https://picsum.photos/150/150?text=User',
  post: 'https://picsum.photos/400/300?text=Post',
  event: 'https://picsum.photos/400/300?text=Event',
  group: 'https://picsum.photos/400/300?text=Group',
};
